...
def banner():
 ...
 _|    _|  _|    _|  _|                    _|  _|          _|                   
 _|_|_|_|  _|_|_|      _|_|    _|_|_|_|_|  _|  _|        _|    {k} BY : ARS-07
 _|    _|  _|    _|        _|              _|  _|      _|     
 _|    _|  _|    _|  _|_|_|                  _|      _|  
           '''))          
#--------------------[ BAGIAN-MASUK ]--------------#
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r 🖕😎🖕 ARS-07 🖕😎🖕      {P}{b}{loop}{P}/{u}{len(id)}{P} OK {P}{H}{ok}{P} CP {P}{k}{cp}{x} : {bo}{'{:.0%}'.format(loop/float(len(id)))}{P}  "), 
	sys.stdout.flush()
